...
function oy_deny_process(oy_deny_reason) {
    return (oy_deny_reason==="OY_DENY_LATENCY_DROP"||oy_deny_reason==="OY_DENY_LATENCY_WEAK"||oy_deny_reason==="OY_DENY_PEER_UNREADY"||oy_deny_reason.indexOf("OY_DENY_DEFLATE_")!==-1)?3:2
}
