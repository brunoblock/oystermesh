...
window.OY_BLOCK_STABILITY_MIN = 1.6;//minimum value for stability_roster, lower means more sybil-attack secure yet more honest block_syncs dropped
...
//window.OY_BLOCK_DIVE_REWARD = window.OY_KEY_BRUNO;
