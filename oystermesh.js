...
const OY_SIM_SNAPSHOT = [
    ...
    "OY_PEER_BOOT_SCALE", "OY_NODE_MAX", "OY_WORK_DELTA", "OY_WORK_DILUTE", "OY_WORK_TARGET", "OY_WORKER_CORES_MIN", "OY_WORKER_CORES_MAX", "OY_LATENCY_SIZE", "OY_LATENCY_GEO", "OY_BLOCK_BOOT_MARK",
    ...
    "OY_BLOCK_METAHASH_PRE", "OY_BLOCK_FLAT", "OY_BLOCK_COMPRESS", "OY_BLOCK_DIFF", "OY_BLOCK_END", "OY_BLOCK_SIGN", "OY_BLOCK_TIME", "OY_BLOCK_NEXT", "OY_BLOCK_BOOT", "OY_BLOCK_UPTIME", "OY_BLOCK_WEIGHT", "OY_BLOCK_ELAPSED", "OY_BLOCK_STABILITY", "OY_BLOCK_STABILITY_KEEP",
    ...
    "OY_SYNC_COUNTER", "OY_BLOCK_CHALLENGE", "OY_BLOCK_NEW", "OY_BLOCK_NEW_PRE", "OY_BLOCK_NEW_JUMP", "OY_BLOCK_CONFIRM", "OY_BLOCK_HALT", "OY_DIFF_TRACK", "OY_LIGHT_ACTIVATE", "OY_REPORT_HASH", "OY_DB", "OY_ERROR_BROWSER"
];
...
function oy_block_engine() {
    ...
    if (oy_block_time_local!==OY_BLOCK_TIME&&(oy_block_time_local/10)%6===0) {
        ...
        oy_chrono(function() {
            if (Object.keys(OY_NODES).length>=OY_NODE_MAX) return false;
