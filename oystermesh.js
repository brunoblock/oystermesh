...
window.OY_BLOCK_CONSENSUS = 0.68;//mesh topology corroboration to agree on confirming a meshblock transaction
...
window.OY_BLOCK_DENSITY = 0.62;//higher means block syncs [0] and dives [1] are more spread out within their respective meshblock sectors
...
window.OY_BLOCK_SEEDTIME = 1554773600;//timestamp to boot the mesh
...
window.OY_LATENCY_GEO_SENS = 14;//percentage buffer for comparing latency with peers, higher means less likely weakest peer will get dropped and mesh is less geo-sensitive
