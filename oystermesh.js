...
window.OY_BLOCK_CONSENSUS = 0.55;//mesh topology corroboration to agree on confirming a meshblock transaction
...
window.OY_BLOCK_STABILITY_MIN = 8.5;//lower means more sybil-attack secure yet more honest block_syncs dropped, lower value forces a more even mesh, relates to GEO_SENS
...
window.OY_BLOCK_RANGE_MIN = 25;//minimum syncs/dives required to not locally reset the meshblock, higher means side meshes die easier
window.OY_BLOCK_SEEDTIME = 1556123600;//timestamp to boot the mesh
